...
class Robot:
    ...
    def move(self):
        ...
        # if self.move_duration <= 0 and self.i<=len(self.plan_tree)-1:
        #     plan = self.plan_tree[self.i]
        #     self.i += 1
        ...
        # if self.i >= len(self.plan_tree) and self.move_duration <= 0:
        #     self.velocity = 0
    ...
    def ackermann(self, x, y, theta, delta, velocity, wheelbase, duration = 1/FPS, a_sum = 0):
        '''
